...
{   
    ...
    {
        if (Input.GetKeyDown(KeyCode.Alpha1) && P1.tag != "Prisoner1")
        {
            SwitchToPlayer(P1);
            playerHighlight(P1);
            SwitcherNumber = 1;
        }
        else if (Input.GetKeyDown(KeyCode.Alpha2) && P3.tag != "Prisoner1")
        {
            SwitchToPlayer(P2);
            playerHighlight(P2);
            SwitcherNumber = 2;
        }
        else if (Input.GetKeyDown(KeyCode.Alpha3) && P3.tag != "Prisoner1")
        {
            SwitchToPlayer(P3);
            playerHighlight(P3);
            SwitcherNumber = 3;
